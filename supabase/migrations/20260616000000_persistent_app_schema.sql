...
DROP POLICY IF EXISTS "public_delete_admins" ON admins;
CREATE POLICY "public_select_admins" ON admins FOR SELECT TO anon, authenticated USING (true);
...
CREATE POLICY "public_delete_admins" ON admins FOR DELETE TO anon, authenticated USING (true);
